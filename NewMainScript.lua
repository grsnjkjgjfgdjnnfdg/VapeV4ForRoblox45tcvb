...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		local res = game:HttpGet("https://raw.githubusercontent.com/grsnjkjgjfgdjnnfdg/VapeV4ForRoblox45tcvb/main/"..scripturl, true)
...
local function checkassetversion()
	local req = requestfunc({
		Url = "https://raw.githubusercontent.com/grsnjkjgjfgdjnnfdg/VapeV4ForRoblox45tcvb/main/assetsversion.dat",
		Method = "GET"
	})
...
checkpublicrepo = function(id)
	local suc, req = pcall(function() return requestfunc({
		Url = "https://raw.githubusercontent.com/grsnjkjgjfgdjnnfdg/VapeV4ForRoblox45tcvb/main/CustomModules/"..id..".lua",
		Method = "GET"
	}) end)
	if not suc then
...
local function getcustomassetfunc(path)
	if not betterisfile(path) then
		...
		local req = requestfunc({
			Url = "https://raw.githubusercontent.com/grsnjkjgjfgdjnnfdg/VapeV4ForRoblox45tcvb/main/"..path:gsub("vape/assets", "assets"),
			Method = "GET"
		})
...
OnlineProfilesButton.MouseButton1Click:Connect(function()
	...
	if profilesloaded == false then
		...
		for i,v in pairs(grabdata("https://raw.githubusercontent.com/grsnjkjgjfgdjnnfdg/VapeV4ForRoblox45tcvb/main/Profiles/"..saveplaceid.."/profilelist.txt")) do 
			onlineprofiles[i] = v
		end
		for i2,v2 in pairs(onlineprofiles) do
			local profileurl = "https://raw.githubusercontent.com/grsnjkjgjfgdjnnfdg/VapeV4ForRoblox45tcvb/main/Profiles/"..saveplaceid.."/"..v2.OnlineProfileName
...
local teleportfunc = game:GetService("Players").LocalPlayer.OnTeleport:Connect(function(State)
    if State == Enum.TeleportState.Started and not shared.VapeIndependent then
		local teleportstr = 'shared.VapeSwitchServers = true if shared.VapeDeveloper then loadstring(readfile("vape/NewMainScript.lua"))() else loadstring(game:HttpGet("https://raw.githubusercontent.com/grsnjkjgjfgdjnnfdg/VapeV4ForRoblox45tcvb/main/NewMainScript.lua", true))() end'
		if shared.VapeDeveloper then
